...
<div class="container-fluid">
    <form method="post" action="/getdatewisereport" class="form-control">
    <h3 style="text-align: center;">Get Datewise Sales Report From Here</h3><hr>
    @csrf
        <div class="mb-3">
        ...
        <!--<button class="btn btn-info mt-3" type="submit" name="submit">Get Datewise Report</button>-->
    </form>
</div>
