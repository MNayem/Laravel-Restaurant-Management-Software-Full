...
<div class="wrapper rounded bg-white">
    <div class="h3">Add Yeasin Daily Sale</div><hr>
        <div class="form">
            <form method="post" action="/adddailysaleyeasin" class="form-control">
            @csrf
                <div class="row">
                    ...
                    <!--<div class="col-md-6 mt-md-0 mt-3"> <label style="color: green;">Deliveryman Name</label> <select id="sub" name="name" required>
                        ...
                        <div class="col-md-6 mt-md-0 mt-3"> <label style="font-weight: bold;">Deliveryman Name</label> <input type="text" placeholder="Yeasin" name="deliverymanname" class="form-control" disabled> </div>
                </div>
                <div class="row">
