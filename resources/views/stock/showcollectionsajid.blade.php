...
<table class="table table-bordered table-dark" style="margin-left: 160px;">
  <thead>
  <th colspan="10"><h2 style="text-align: center; color: yellow;">SAJID Collection LIST</h2></th>
  ...
  <tbody>
     @foreach ($showcollectionsajid as $showcollectionsajid)
    <tr align="center">
      <th scope="row">{{ $showcollectionsajid->id }}</th>
       <td>{{ $showcollectionsajid->date}}</td>
        <td>{{ $showcollectionsajid->deliveryman }}</td>
        <td>{{ $showcollectionsajid->shopname }}</td>
        <td>{{ $showcollectionsajid->dueamount }}</td>
        <td>{{ $showcollectionsajid->collectionamount }}</td>
        <td>{{ $showcollectionsajid->amountleft}}</td>
        
        <td colspan = "3">
            <a href="{{ url('/collectionedit',$showcollectionsajid->id) }}" class="btn btn-primary">Edit </a>
            <a href="{{ url('/deletecollection',$showcollectionsajid->id) }}" class="btn btn-danger ml-2">Delete</a>
        </td>
    </tr>
    @endforeach
  </tbody>
