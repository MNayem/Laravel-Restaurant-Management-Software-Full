...
<table class="table table-bordered table-dark" style="margin-left: 160px;">
  <thead>
  <th colspan="10"><h2 style="text-align: center; color: yellow;">HRIDOY Collection LIST</h2></th>
  ...
  <tbody>
     @foreach ($showcollectionhridoy as $showcollectionhridoy)
    <tr align="center">
      <th scope="row">{{ $showcollectionhridoy->id }}</th>
       <td>{{ $showcollectionhridoy->date}}</td>
        <td>{{ $showcollectionhridoy->deliveryman }}</td>
        <td>{{ $showcollectionhridoy->shopname }}</td>
        <td>{{ $showcollectionhridoy->dueamount }}</td>
        <td>{{ $showcollectionhridoy->collectionamount }}</td>
        <td>{{ $showcollectionhridoy->amountleft}}</td>
        
        <td colspan = "3">
            <a href="{{ url('/collectionedit',$showcollectionhridoy->id) }}" class="btn btn-primary">Edit </a>
            <a href="{{ url('/deletecollection',$showcollectionhridoy->id) }}" class="btn btn-danger ml-2">Delete</a>
        </td>
    </tr>
    @endforeach
  </tbody>
