...
<table class="table table-bordered table-dark" style="margin-left: 160px;">
  <thead>
  <th colspan="10"><h2 style="text-align: center; color: yellow;">JAHNGIR Collection LIST</h2></th>
  ...
  <tbody>
     @foreach ($showcollectionjahangir as $showcollectionjahangir)
    <tr align="center">
      <th scope="row">{{ $showcollectionjahangir->id }}</th>
       <td>{{ $showcollectionjahangir->date}}</td>
        <td>{{ $showcollectionjahangir->deliveryman }}</td>
        <td>{{ $showcollectionjahangir->shopname }}</td>
        <td>{{ $showcollectionjahangir->dueamount }}</td>
        <td>{{ $showcollectionjahangir->collectionamount }}</td>
        <td>{{ $showcollectionjahangir->amountleft}}</td>
        
        <td colspan = "3">
            <a href="{{ url('/collectionedit',$showcollectionjahangir->id) }}" class="btn btn-primary">Edit </a>
            <a href="{{ url('/deletecollection',$showcollectionjahangir->id) }}" class="btn btn-danger ml-2">Delete</a>
        </td>
    </tr>
    @endforeach
  </tbody>
