...
<table class="table table-bordered table-dark" style="margin-left: 160px;">
  <thead>
  <th colspan="10"><h2 style="text-align: center; color: yellow;">OTHERS Collection LIST</h2></th>
  ...
  <tbody>
     @foreach ($showcollectionothers as $showcollectionothers)
    <tr align="center">
      <th scope="row">{{ $showcollectionothers->id }}</th>
       <td>{{ $showcollectionothers->date}}</td>
        <td>{{ $showcollectionothers->deliveryman }}</td>
        <td>{{ $showcollectionothers->shopname }}</td>
        <td>{{ $showcollectionothers->dueamount }}</td>
        <td>{{ $showcollectionothers->collectionamount }}</td>
        <td>{{ $showcollectionothers->amountleft}}</td>
        
        <td colspan = "3">
            <a href="{{ url('/collectionedit',$showcollectionothers->id) }}" class="btn btn-primary">Edit </a>
            <a href="{{ url('/deletecollection',$showcollectionothers->id) }}" class="btn btn-danger ml-2">Delete</a>
        </td>
    </tr>
    @endforeach
  </tbody>
