...
<div class="wrapper rounded bg-white">
    <div class="h3">Add Damage Product</div><hr>
    <div class="form">
        <form method="post" action="/adddamageproduct">
            @csrf
        <div class="row">
            <div class="col-md-6 mt-md-0 mt-3"> <label>Date</label> <input type="date" placeholder="Date" name="date" class="form-control" required> </div>
        ...
        <div class="row">
             <div class="col-md-6 mt-md-0 mt-3"> <label>Total Product</label> <input type="number" name="totalproduct" placeholder="Total Product" class="form-control" required> </div>
        </div>
        <div class="text-right">
            <button class="btn btn-primary mt-3" type="submit" name="submit">Confirm Damage Product</button>
        </div>
        </form>
    </div>
</div>
