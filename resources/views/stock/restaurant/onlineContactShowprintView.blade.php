  ...
  <body>
    ...
    <section>
        <div class="container-fluid">
            ...
            <div class="row">
                <span></span>
                <span class="fw-bold" style="margin-left:-10px;">Contact Person Details</span>  <br><hr>
                Contact Person Email: {{ $printView->email }}<br>
                Contact Person Phone: {{ $printView->phone }}<br>
                Subject: {{ $printView->subject }}<br>
                Message: TK. {{ $printView->message }}<br>
            </div>
        </div>
    </section>
