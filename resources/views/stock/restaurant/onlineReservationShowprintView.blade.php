  ...
  <body>
    ...
    <section>
        <div class="container-fluid">
            ...
            <div class="row">
                <span></span>
                <span class="fw-bold" style="margin-left:-10px;">Reservation Details</span>  <br><hr>
                Total Person: {{ $printView->totalperson }}<br>
                Time: {{ $printView->time }}<br>
                Mobile No: {{ $printView->phone }}<br>
                Date: TK. {{ $printView->date }}<br>
            </div>
        </div>
    </section>
