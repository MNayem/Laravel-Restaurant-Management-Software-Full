        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <table class="table table-borderless">
                     <thead>
                        <tr align="center" style="font-size: 13px; font-family: thoma;">
                          <th scope="col">ID</th>
                      ...
                      <tbody>
                          <tr align="center" style="font-size: 12px; font-weight: bold; font-family: thoma;">
                              <td>{{ $printView->id }}</td>
                              <td>{{ $printView->fname }}</td>
                              <td>TK. {{ $printView->amount }}</td>
                              <td>{{ $printView->orders  }}</td>
                              <td>TK.{{ $printView->tamount  }}</td>
                          </tr>
                      </tbody>
                </table>
            </div>
