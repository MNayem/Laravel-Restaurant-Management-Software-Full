    ...
    <section>
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                Customer Name: {{ $printView->name }}<br>
                Mobile No: {{ $printView->phone_no }}<br>
                Food Item Name: {{ $printView->pname }}<br>
                Amount: TK. {{ $printView->amount }}<br>
                Vat: TK. {{ $printView->vat }}<br>
                Number of Orders: {{ $printView->quantity }}<br>
                Total Payable Amount: TK. {{ $printView->tamount }}
            </div>
        </div>
    </section>
