...
<div class="collapse navbar-collapse" id="navbarNav">
  ...
  <div class="sidenav">
    ...
    <a href="/admin/home" class="btn btn-dark py-3">Dashboard</a><br>
    
    <a href="/productadd" class="btn btn-info">Product Add </a>
    <a href="/productshow" class="btn btn-dark">All Products Show </a>
    
    <a href="/foodadd" class="btn btn-info">Food Add </a>
    <a href="/foodshow" class="btn btn-dark">All Food Items Show </a>
    
    <a href="/stockadd" class="btn btn-info">Stock Add</a>
    <a href="/stockshow" class="btn btn-dark">Stock Show </a>
    
     <a href="/ingredientsadd" class="btn btn-info">Ingredients Add </a>
    <a href="/ingredientsShow" class="btn btn-dark">Ingredients Details </a>
    
    <a href="/dailysaleRestaurantadd" class="btn btn-info">Add Order</a>
    <a href="/dailysaleshowRestaurant" class="btn btn-dark">Show Order</a>
    
    <a href="/allOnlineOrder" class="btn btn-info">Show Online Order </a>
    ...
    <a href="/productcart" class="btn btn-info">Product Cart</a>
