...
<table class="table table-bordered table-dark" style="margin-left: 160px;">
    ...
    <thead class="header">
        <th colspan="9"><h2 style="text-align: center; color: yellow;">OTHERS EXPENSE FIELD</h2></th>
    ...
    <tbody>
        @foreach ($expenseshowothers as $expenseshowothers)
        <tr align="center">
            <td>{{ $expenseshowothers->id }}</td>
            <td>{{ $expenseshowothers->date }}</td>
            <td>{{ $expenseshowothers->expname }}</td>
            <td>{{ $expenseshowothers->amount }}</td>
            <td>{{ $expenseshowothers->deliverymanname }}</td>
            <td>{{ $expenseshowothers->description }}</td>
            <td colspan = 3>
                <a href="{{ url('/expenseedit',$expenseshowothers->id) }}" class="btn btn-primary">Edit </a>
                <a href="{{ url('/deleteexpense',$expenseshowothers->id) }}" class="btn btn-danger">Delete</a>
            </td>
        </tr>
    @endforeach
    </tbody>
