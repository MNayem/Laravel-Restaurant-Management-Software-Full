...
<table class="table table-bordered table-dark" style="margin-left: 160px;">
    ...
    <thead class="header">
        <th colspan="9"><h2 style="text-align: center; color: yellow;">YEASIN EXPENSE FIELD</h2></th>
    ...
    <tbody>
        @foreach ($expenseshowyeasin as $expenseshowyeasin)
        <tr align="center">
            <td>{{ $expenseshowyeasin->id }}</td>
            <td>{{ $expenseshowyeasin->date }}</td>
            <td>{{ $expenseshowyeasin->expname }}</td>
            <td>{{ $expenseshowyeasin->amount }}</td>
            <td>{{ $expenseshowyeasin->deliverymanname }}</td>
            <td>{{ $expenseshowyeasin->description }}</td>
            <td colspan = 3>
                <a href="{{ url('/expenseedit',$expenseshowyeasin->id) }}" class="btn btn-primary">Edit </a>
                <a href="{{ url('/deleteexpense',$expenseshowyeasin->id) }}" class="btn btn-danger">Delete</a>
            </td>
        </tr>
    @endforeach
    </tbody>
