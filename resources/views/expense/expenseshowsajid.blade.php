...
<table class="table table-bordered table-dark" style="margin-left: 160px;">
    ...
    <thead class="header">
        <th colspan="9"><h2 style="text-align: center; color: yellow;">SAJID EXPENSE FIELD</h2></th>
    ...
    <tbody>
        @foreach ($expenseshowsajid as $expenseshowsajid)
        <tr align="center">
            <td>{{ $expenseshowsajid->id }}</td>
            <td>{{ $expenseshowsajid->date }}</td>
            <td>{{ $expenseshowsajid->expname }}</td>
            <td>{{ $expenseshowsajid->amount }}</td>
            <td>{{ $expenseshowsajid->deliverymanname }}</td>
            <td>{{ $expenseshowsajid->description }}</td>
            <td colspan = 3>
                <a href="{{ url('/expenseedit',$expenseshowsajid->id) }}" class="btn btn-primary">Edit </a>
                <a href="{{ url('/deleteexpense',$expenseshowsajid->id) }}" class="btn btn-danger">Delete</a>
            </td>
        </tr>
    @endforeach
    </tbody>
