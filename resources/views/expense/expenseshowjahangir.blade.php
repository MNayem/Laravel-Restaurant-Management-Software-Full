...
<table class="table table-bordered table-dark" style="margin-left: 160px;">
    ...
    <thead class="header">
        <th colspan="9"><h2 style="text-align: center; color: yellow;">JAHANGIR EXPENSE FIELD</h2></th>
    ...
    <tbody>
        @foreach ($expenseshowjahangir as $expenseshowjahangir)
        <tr align="center">
            <td>{{ $expenseshowjahangir->id }}</td>
            <td>{{ $expenseshowjahangir->date }}</td>
            <td>{{ $expenseshowjahangir->expname }}</td>
            <td>{{ $expenseshowjahangir->amount }}</td>
            <td>{{ $expenseshowjahangir->deliverymanname }}</td>
            <td>{{ $expenseshowjahangir->description }}</td>
            <td colspan = 3>
                <a href="{{ url('/expenseedit',$expenseshowjahangir->id) }}" class="btn btn-primary">Edit </a>
                <a href="{{ url('/deleteexpense',$expenseshowjahangir->id) }}" class="btn btn-danger">Delete</a>
            </td>
        </tr>
    @endforeach
    </tbody>
