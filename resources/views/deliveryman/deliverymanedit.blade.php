...
<center><h1>Edit This Deliveryman Info.</h1><br></center>
            <hr>
        <div class="wrapper rounded bg-white">
            <form action="{{ url('/deliverymaneditprocess',$data->id) }}" method="post">
                @csrf
                <label>Deliveryman Name: </label>
                <input type="text" name="name" placeholder="Deliveryman Name" value="{{ $data->name }}"><br><br>
                <label>Email: </label>
