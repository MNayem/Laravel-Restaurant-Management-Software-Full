...
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
                    <form action="/kotOrderAddT13" method="post">
                            @csrf
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <table class="table table-borderless">
                     ...
                     <tbody>
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
                          @foreach ($kotPrintShowT13 as $kotPrintShowT13)
                          <tr align="center" style="font-size: 14px; font-weight: bold; font-family: thoma;">
                              <td>{{ $kotPrintShowT13->food_number }}</td>
                              <td>{{ $kotPrintShowT13->fname  }}</td>
                              <td>{{ $kotPrintShowT13->product_quantity  }}</td>
                          </tr>
                          @endforeach
                      </tbody>
                </table>
