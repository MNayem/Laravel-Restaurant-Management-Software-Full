...
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
                    <form action="/kotOrderAddT18" method="post">
                            @csrf
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <table class="table table-borderless">
                     ...
                     <tbody>
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
                          @foreach ($kotPrintShowT18 as $kotPrintShowT18)
                          <tr align="center" style="font-size: 14px; font-weight: bold; font-family: thoma;">
                              <td>{{ $kotPrintShowT18->food_number }}</td>
                              <td>{{ $kotPrintShowT18->fname  }}</td>
                              <td>{{ $kotPrintShowT18->product_quantity  }}</td>
                          </tr>
                          @endforeach
                      </tbody>
                </table>
