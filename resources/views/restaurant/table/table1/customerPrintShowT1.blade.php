        ...
        <div class="row">
          ...
          <div class="col-lg-7 col-md-12 col-12 kotSection py-3">
            ...
            <div class="row d-flex justify-content-center pt-3">
              ...
              <form method="get" action="/customerPrintState3">
                  @csrf
          ...
          <div class="col-lg-5 col-md-12 col-12 customerSection bg-dark py-3" style="min-height:85vh;">
            ...
            <div class="row mx-1 justify-content-end" style="border: 2px solid white; border-radius: .5rem;min-height:20px;">
              <div> 
                ...
                <form action="{{ url('/customerPrintOrderUpdate',$orderId->id) }}" method="post">
                  @csrf
                  
              <!--<div class="row pt-1">-->
              <!--  <label for="inputPassword" class="col-lg-5 col-form-label text-light fw-bold">Discount (%): </label>-->
              <!--  <div class="col-lg-7">-->
              <!--    <input type="number" class="form-control" step="any" name="discount_percentage" value="{{ $orderId->discount_percentage }}" placeholder="0" style="text-align: end;">-->
              <!--  </div>-->
              <!--</div>-->
              <!--<div class="row pt-1">-->
              <!--  <label for="inputPassword" class="col-lg-5 col-form-label text-light fw-bold">Discount (Extra) : </label>-->
              <!--  <div class="col-lg-7">-->
              <!--    <input type="number" class="form-control" step="any" name="discount_amount_number" value="{{ $orderId->discount_amount_number }}" placeholder="0" style="text-align: end;">-->
              <!--  </div>-->
              <!--</div>-->
