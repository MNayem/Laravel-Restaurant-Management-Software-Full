...
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
                  <form action="/addtable19carts" method="post" style="width:100%;border:2px solid gray; padding: .5rem; border-radius: .5rem;">
                    @csrf
                    @foreach ($food as $food)
                      ...
                      <div class="row">
                        ...
                        <div class="col-8">
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
                          <input type="number" name="tablenumber" value="19" style="width:100%;border:none;">
                        </div>
                      </div>
