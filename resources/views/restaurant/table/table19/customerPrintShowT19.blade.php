                  ...
                  <thead>
                    <tr class="text-danger" style=" font-size: 1.2rem;">
                      ...
                      <tbody>
                          ...
                          @endphp
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
                          @foreach ($customerPrintShowT19 as $customerPrintShowT19)
                          <tr align="center" style="font-size: 15px; font-weight: bold; font-family: thoma;">
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
                              <td>{{ $customerPrintShowT19->order_id }}</td>
                              <td>{{ $customerPrintShowT19->tablenumber  }}</td>
                              <td>{{ $customerPrintShowT19->fname  }}</td>
                              <td>{{ $customerPrintShowT19->product_quantity  }}</td>
                              <td>{{ $customerPrintShowT19->amount  }}</td>
                              <td>
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
                                 @php
                                    $total_price += $customerPrintShowT19->amount * $customerPrintShowT19->product_quantity;
                                 @endphp
                                  {{ $customerPrintShowT19->amount * $customerPrintShowT19->product_quantity }}
                              </td>
                          </tr>
                          @endforeach
...
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
              <form method="get" class="text-center" action="/customerPrintState3T19">
                  @csrf
          ...
          <div class="col-lg-5 col-md-12 col-12 customerSection bg-dark py-3" style="min-height:85vh;">
            ...
            <div class="row mx-1 justify-content-end" style="border: 2px solid white; border-radius: .5rem;min-height:20px;">
              <div> 
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
            <form action="{{ url('/customerPrintOrderUpdate19',$orderId->id) }}" method="post">
                  @csrf
              <div class="row pt-1">
