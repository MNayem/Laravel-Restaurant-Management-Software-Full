        ...
        <div class="container-fluid">
            ...
            <div class="row text-center align-self-center" style="border-top:1px solid gray;border-bottom:1px solid gray;">
                ...
                <div class="col-6 align-self-center" style="text-align:right;">
                    <form action="/customerPrintShowT2updateStatus" method="post">
                        @csrf
            ...
            <div class="row">
                ...
                <table class="table table-borderless">
                     ...
                     <tbody>
                         ...
                         <!--       <td colspan="3" style="font-size: 18px; font-family: thoma; font-weight: bold;text-align:right;">-->
                         <!--          Total :-->
                         <!--       </td>-->
                         ...
                         <!--       </td>-->
                         <!--       <td colspan="2" style="text-align:right;">-->
                         <!--         <strong>{{ $waiterName->discount_amount }}  /=</strong>-->
                         <!--       </td>-->
                         <!-- </tr>-->
                         <!-- <tr>-->
                         <!--       <td colspan="3" style="font-size: 18px; font-family: thoma; font-weight: bold;text-align:right;">-->
                         ...
                         <!--       </td>-->
                         <!--       <td colspan="2" style="text-align:right;">-->
                         <!--         <strong>{{ $waiterName->discount_amount_number }}  /=</strong>-->
                         <!--       </td>-->
                         <!-- </tr>-->
                         <!-- <tr>-->
                         <!--       <td colspan="3" style="font-size: 18px; font-family: thoma; font-weight: bold;text-align:right;">-->
                         ...
                         <!--       </td>-->
                         <!--       <td colspan="2" style="text-align:right;">-->
                         <!--         <strong> {{ ($total_price + $waiterName->vat) - ($waiterName->discount_amount + $waiterName->discount_amount_number) }}  /=</strong>-->
                         <!--       </td>-->
                         <!-- </tr>-->
                         <!-- <tr>-->
                         <!--       <td colspan="3" style="font-size: 18px; font-family: thoma; font-weight: bold;text-align:right;">-->
                         ...
                         <!--       </td>-->
                         <!--       <td colspan="2" style="text-align:right;">-->
                         <!--         <strong> {{ $waiterName->given_amount }}  /=</strong>-->
                         <!--       </td>-->
                         <!-- </tr>-->
                         <!-- <tr>-->
                         <!--       <td colspan="3" style="font-size: 18px; font-family: thoma; font-weight: bold;text-align:right;">-->
                         ...
                         <!--       </td>-->
                         <!--       <td colspan="2" style="text-align:right;">-->
                         <!--         <strong> {{ $waiterName->given_amount - (($total_price + $waiterName->vat) - ($waiterName->discount_amount + $waiterName->discount_amount_number)) }}  /=</strong>-->
                         <!--       </td>-->
                         <!-- </tr>-->
                      </tbody>
                </table>
