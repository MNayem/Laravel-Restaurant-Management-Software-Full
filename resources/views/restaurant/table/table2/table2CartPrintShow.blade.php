        ...
        <div class="row">
          ...
          <div class="col-lg-7 col-md-12 col-12 kotSection py-3">
                ...
                <table class="table table-light table-striped table-hover text-center">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <form class="form-inline" action="{{ url('/quantityDeleteFront2',$tableCartsPrintShow->id) }} }}" method="get">
                            @csrf
            ...
            <div class="row d-flex justify-content-center pt-3">
              <form method="post" action="/kotPrintT2">
                  @csrf
          ...
          <div class="col-lg-5 col-md-12 col-12 customerSection bg-dark py-3" style="min-height:85vh;">
            ...
            <form action="/customerPrint2" method="post">
                  @csrf
              
              <div class="row pt-1">
                <!--<label for="inputPassword" class="col-5 col-form-label text-light fw-bold">Order ID :</label>-->
                <div class="col-7">
              ...
              <div class="row pt-1">
                ...
                <div class="col-lg-7">
                  ...
                  <!--<input type="cname" name="cname" placeholder="Enter Customer Name"><br><br>-->
