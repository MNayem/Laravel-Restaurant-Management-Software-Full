...
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
                  <form action="/searchT7" method="post" style="width: 100%;">
                      @csrf  
                ...
                <table class="table table-light table-striped table-hover text-center">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
                        <form class="form-inline" action="{{ url('/quantityDeleteFront7',$tableCartsPrintShow->id) }} }}" method="get">
                            @csrf
...
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
              <form method="post" class="text-center" action="/kotPrintT7">
                  @csrf
          ...
          <div class="col-lg-5 col-md-12 col-12 customerSection bg-dark py-3" style="min-height:85vh;">
            ...
            <div class="row mx-1 justify-content-end" style="border: 2px solid white; border-radius: .5rem;min-height:200px;">
              <div> 
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
            <form action="/customerPrint7" method="post">
                  @csrf
              <div class="row pt-1">
                <div class="col-7">
