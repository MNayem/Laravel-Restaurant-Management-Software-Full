...
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
                    <form action="/kotOrderAddT15" method="post">
                            @csrf
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <table class="table table-borderless">
                     ...
                     <tbody>
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
                          @foreach ($kotPrintShowT15 as $kotPrintShowT15)
                          <tr align="center" style="font-size: 14px; font-weight: bold; font-family: thoma;">
                              <td>{{ $kotPrintShowT15->food_number }}</td>
                              <td>{{ $kotPrintShowT15->fname  }}</td>
                              <td>{{ $kotPrintShowT15->product_quantity  }}</td>
                          </tr>
                          @endforeach
                      </tbody>
                </table>
