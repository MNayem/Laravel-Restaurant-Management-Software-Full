                  ...
                  <thead>
                    <tr class="text-danger" style=" font-size: 1.2rem;">
                      ...
                      <tbody>
                          ...
                          @endphp
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
                          @foreach ($customerPrintShowT3 as $customerPrintShowT3)
                          <tr align="center" style="font-size: 15px; font-weight: bold; font-family: thoma;">
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
                              <td>{{ $customerPrintShowT3->order_id }}</td>
                              <td>{{ $customerPrintShowT3->tablenumber  }}</td>
                              <td>{{ $customerPrintShowT3->fname  }}</td>
                              <td>{{ $customerPrintShowT3->product_quantity  }}</td>
                              <td>{{ $customerPrintShowT3->amount  }}</td>
                              <td>
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
                                 @php
                                    $total_price += $customerPrintShowT3->amount * $customerPrintShowT3->product_quantity;
                                 @endphp
                                  {{ $customerPrintShowT3->amount * $customerPrintShowT3->product_quantity }}
                              </td>
                          </tr>
                          @endforeach
...
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
              <form method="get" class="text-center" action="/customerPrintState3TA3">
                  @csrf
          ...
          <div class="col-lg-5 col-md-12 col-12 customerSection bg-dark py-3" style="min-height:85vh;">
            ...
            <div class="row mx-1 justify-content-end" style="border: 2px solid white; border-radius: .5rem;min-height:20px;">
              <div> 
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
            <form action="{{ url('/customerPrintOrderUpdateTA3',$orderId->id) }}" method="post">
                  @csrf
              <div class="row pt-1">
