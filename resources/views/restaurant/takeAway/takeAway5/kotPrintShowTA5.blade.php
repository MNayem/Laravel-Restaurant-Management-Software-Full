...
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
                    <form action="/kotOrderAddTA5" method="post">
                            @csrf
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <table class="table table-borderless">
                     ...
                     <tbody>
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
                          @foreach ($kotPrintShowT5 as $kotPrintShowT5)
                          <tr align="center" style="font-size: 14px; font-weight: bold; font-family: thoma;">
                              <td>{{ $kotPrintShowT5->food_number }}</td>
                              <td>{{ $kotPrintShowT5->fname  }}</td>
                              <td>{{ $kotPrintShowT5->product_quantity  }}</td>
                          </tr>
                          @endforeach
                      </tbody>
                </table>
