...
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
                  <form action="/searchTA1" method="post" style="width: 100%;">
                      @csrf  
                ...
                <table class="table table-light table-striped table-hover text-center">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
                        <form class="form-inline" action="{{ url('/quantityDeleteFrontTA1',$tableCartsPrintShow->id) }} }}" method="get">
                            @csrf
...
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
              <form method="post" class="text-center" action="/kotPrintTA1">
                  @csrf
          ...
          <div class="col-lg-5 col-md-12 col-12 customerSection bg-dark py-3" style="min-height:90vh;">

            <div class="row mx-1 justify-content-end" style="border: 2px solid white; border-radius: .5rem;min-height:200px;">
              <div> 
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
            <form action="/customerPrintTA1" method="post">
                  @csrf
              <div class="row pt-1">
                <div class="col-7">
              ...
              <div class="row pt-1">
                <label for="inputPassword" class="col-lg-5 col-form-label text-light fw-bold">Total Amount (tk) : </label>
                <div class="col-lg-7">
              ...
              <div class="row pt-1">
                <label for="inputPassword" class="col-lg-5 col-form-label text-light fw-bold">Waiter Name : </label>
                <div class="col-lg-7">
              ...
              <div class="row pt-1">
                <label for="inputPassword" class="col-lg-5 col-form-label text-light fw-bold">Vat (%): </label>
                <div class="col-lg-7">
                  <input type="number" class="form-control" step="any" name="vat" placeholder="0" style="text-align: end;">
                </div>
              </div>
              <div class="row pt-1">
                <label for="inputPassword" class="col-lg-5 col-form-label text-light fw-bold">S / C (%): </label>
                <div class="col-lg-7">
                  <input type="number" class="form-control" step="any" name="s_charge" placeholder="0" style="text-align: end;">
                </div>
              </div>
              <div class="row pt-1">
                <label for="inputPassword" class="col-lg-5 col-form-label text-light fw-bold">Discount (%): </label>
                <div class="col-lg-7">
              ...
              <div class="row pt-1" style="display:none;">
                <label for="inputPassword" class="col-lg-5 col-form-label text-light fw-bold">Discount Amount: </label>
                <div class="col-lg-7">
                  <input type="number" class="form-control" step="any" name="discount_amount" placeholder="0" disabled style="text-align: end;">
                </div>
              </div>
              <div class="row pt-1">
                <label for="inputPassword" class="col-lg-5 col-form-label text-light fw-bold">Discount (Extra) : </label>
                <div class="col-lg-7">
