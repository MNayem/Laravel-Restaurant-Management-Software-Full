      ...
      <section>
        <div class="container-fluid">
            ...
            <div class="row text-center align-self-center" style="border-top:1px solid gray;border-bottom:1px solid gray;">
                ...
                <div class="col-6 align-self-center" style="text-align:end;">
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
                    <form action="/kotOrderAddTA1" method="post">
                            @csrf
    ...
    <section>
        <div class="container-fluid">
            <div class="row">
                ...
                <span class="fw-bold" style="margin-left:-10px;">Take Away Number: {{ $kotTableNumber->tablenumber }}</span>
                <br><hr>
                <table class="table table-borderless">
                     ...
                     <tbody>
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
                          @foreach ($kotPrintShowT1 as $kotPrintShowT1)
                          <tr align="center" style="font-size: 14px; font-weight: bold; font-family: thoma;">
                              <td>{{ $kotPrintShowT1->food_number }}</td>
                              <td>{{ $kotPrintShowT1->fname  }}</td>
                              <td>{{ $kotPrintShowT1->product_quantity  }}</td>
                          </tr>
                          @endforeach
                      </tbody>
                </table>
