                  ...
                  <thead>
                    <tr class="text-danger" style=" font-size: 1.2rem;">
                      ...
                      <tbody>
                          ...
                          @endphp
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
                          @foreach ($customerPrintShowT6 as $customerPrintShowT6)
                          <tr align="center" style="font-size: 15px; font-weight: bold; font-family: thoma;">
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
                              <td>{{ $customerPrintShowT6->order_id }}</td>
                              <td>{{ $customerPrintShowT6->tablenumber  }}</td>
                              <td>{{ $customerPrintShowT6->fname  }}</td>
                              <td>{{ $customerPrintShowT6->product_quantity  }}</td>
                              <td>{{ $customerPrintShowT6->amount  }}</td>
                              <td>
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
                                 @php
                                    $total_price += $customerPrintShowT6->amount * $customerPrintShowT6->product_quantity;
                                 @endphp
                                  {{ $customerPrintShowT6->amount * $customerPrintShowT6->product_quantity }}
                              </td>
                          </tr>
                          @endforeach
...
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
              <form method="get" class="text-center" action="/customerPrintState3TA6">
                  @csrf
          ...
          <div class="col-lg-5 col-md-12 col-12 customerSection bg-dark py-3" style="min-height:85vh;">
            ...
            <div class="row mx-1 justify-content-end" style="border: 2px solid white; border-radius: .5rem;min-height:20px;">
              <div> 
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
            <form action="{{ url('/customerPrintOrderUpdateTA6',$orderId->id) }}" method="post">
                  @csrf
              <div class="row pt-1">
