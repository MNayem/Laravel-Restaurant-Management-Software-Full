...
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
                    <form action="/kotOrderAddTA6" method="post">
                            @csrf
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <table class="table table-borderless">
                     ...
                     <tbody>
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
                          @foreach ($kotPrintShowT6 as $kotPrintShowT6)
                          <tr align="center" style="font-size: 14px; font-weight: bold; font-family: thoma;">
                              <td>{{ $kotPrintShowT6->food_number }}</td>
                              <td>{{ $kotPrintShowT6->fname  }}</td>
                              <td>{{ $kotPrintShowT6->product_quantity  }}</td>
                          </tr>
                          @endforeach
                      </tbody>
                </table>
