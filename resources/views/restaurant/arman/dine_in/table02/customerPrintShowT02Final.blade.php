    ...
    <section>
        <div class="container-fluid">
            ...
            <div class="row" style="text-align:right;font-weight:bold;font-family: thoma;font-size: 1.2rem;border-top:1px solid gray;">
                ...
                <div class="col-4">{{ $waiterName->vat }}  /=</div>
                <div class="col-8">Service Charge :</div>
                <div class="col-4">{{ $waiterName->s_charge }}  /=</div>
                ...
                <div class="col-4"> {{ ($total_price + $waiterName->vat + $waiterName->s_charge) - ($waiterName->discount_amount + $waiterName->discount_amount_number) }}  /=</div>
                <div class="col-8">Received Amount :</div>
                <div class="col-4"> {{ $waiterName->given_amount }}  /=</div>
                <div class="col-8">Changed Amount :</div>
                <div class="col-4"> {{ $waiterName->given_amount - (($total_price + $waiterName->vat + $waiterName->s_charge) - ($waiterName->discount_amount + $waiterName->discount_amount_number)) }}  /=</div>
            </div>
