    ...
    <section>
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-lg-2 col-md-12 col-12 text-center customTableSection bg-dark py-5">
          ...
          <div class="col-lg-6 col-md-12 col-12 kotSection pb-3">
            ...
            <div class="row">
                <div class="col-12">
                  <a href="/printCart02" class="btn btn-dark mt-1 fw-bold" style="width: 100%;">Dsiplay Orders</a>
                </div>
            </div>
