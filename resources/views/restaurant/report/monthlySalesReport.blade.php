...
<div class="container-fluid tbl-container mt-5">
    ...
    <a href="/monthlySalesReport" class="btn btn-dark fw-bold btn3 active1">Monthly Sales</a>
    
    <a href="/monthlySalePrint" class="btn btn-danger fw-bold">Print</a>
    ...
    <div class="row tbl-fixed">
        ...
        <thead>
            <th colspan="11"><h2 style="text-align: center;" class="fw-bold">This Month Sale</h2></th>
            <tr align="center">
        ...
        <tbody>
            @foreach ($monthlySalesReport as $monthlySalesReport)
            <tr align="center" class="align-self-center">
                <td class="align-self-center">{{ $monthlySalesReport->id }}</td>
                <td>{{ $monthlySalesReport->order_id }}</td>
                <td>{{ ($monthlySalesReport->tamount + $monthlySalesReport->vat_amount + $monthlySalesReport->s_charge_amount) - 
                    ($monthlySalesReport->discount_amount + $monthlySalesReport->discount_amount_number) }}</td>
                <td>{{ $monthlySalesReport->cname }}</td>
                <td>{{ $monthlySalesReport->date }}</td>
                <td>{{ $monthlySalesReport->phone_no }}</td>
                <td>{{ $monthlySalesReport->payment_type }}</td>
            </tr>
            @endforeach
        </tbody>
        </table> 
