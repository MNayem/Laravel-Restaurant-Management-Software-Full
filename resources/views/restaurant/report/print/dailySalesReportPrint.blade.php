        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div style="width: 260px; min-height: 260px; border: 1px solid black;">
                    ...
                    @foreach ($dailySalesReportPrint as $dailySalesReportPrint)
                    <div class="row text-center" style="border-bottom: 1px solid gray;">
                        <div class="col-3" style="border-right: 1px solid gray;"> <span class="tableBody">{{ $dailySalesReportPrint->id }}</span> </div>
                        <div class="col-4" style="border-right: 1px solid gray;"> <span class="tableBody">{{ ($dailySalesReportPrint->tamount + $dailySalesReportPrint->vat_amount + $dailySalesReportPrint->s_charge_amount) - 
                            ($dailySalesReportPrint->discount_amount + $dailySalesReportPrint->discount_amount_number) }}</span> </div>
                        <div class="col-5" style="border-right: 1px solid gray;"> <span class="tableBody">{{ $dailySalesReportPrint->date }}</span> </div>
