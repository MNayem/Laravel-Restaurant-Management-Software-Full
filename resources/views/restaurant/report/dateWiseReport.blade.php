                ...
                <div style="width: 260px; min-height: 260px; border: 1px solid black;">
                    ...
                    <div class="row pb-2 justify-content-center" style="background: rgb(192, 192, 192);">
                        <div class="col-12 text-center">
                            <span style="font-size: 18px; font-weight: bold;">Date Wise Sales Report</span>
                    ...
                    <div class="row text-center" style="border-bottom: 1px solid gray;">
                        <div class="col-3" style="border-right: 1px solid gray;"> <span class="tableBody">{{ $dateWiseReport->id }}</span> </div>
                        <div class="col-4" style="border-right: 1px solid gray;"> <span class="tableBody">{{ ($dateWiseReport->tamount + $dateWiseReport->vat_amount + $dateWiseReport->s_charge_amount) - 
                            ($dateWiseReport->discount_amount + $dateWiseReport->discount_amount_number) }}</span> </div>
                        <div class="col-5" style="border-right: 1px solid gray;"> <span class="tableBody">{{ $dateWiseReport->date }}</span> </div>
